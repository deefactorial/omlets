...
import org.openmoney.omlets.gwt.client.ui.widgets.NotificationDisplay;
import org.openmoney.omlets.gwt.client.ui.widgets.NotificationDisplay.Type;
...
public class Notification {
    ...
    private Notification() {
        ...
        container.addAttachHandler(new AttachEvent.Handler() {            
            ...
            public void onAttachOrDetach(AttachEvent event) {
                Omlets_mobile.get().getMainLayout().adjust();
            }
        });
    }  
    ...
    private void show(Type type, String message) {
        ...
        if(layout == NotificationLayout.FIXED) {
            ...
            Omlets_mobile.get().getMainLayout().addNotificationContainerStyle("fixed");
            Omlets_mobile.get().getMainLayout().addPageContainerStyle("fixed");
        }
    ...
    public void alert(String message, String title, String button, AlertCallback callback) {
        Omlets_mobile.get().getPhoneGap().getNotification().alert(message, callback, title, button);
    }
