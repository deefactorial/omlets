 ...
 */
package org.openmoney.omlets.gwt.client.loadgeneraldata;
...
import org.openmoney.omlets.gwt.client.model.Image;
import org.openmoney.omlets.gwt.client.services.GeneralService;
...
import org.openmoney.omlets.gwt.client.utils.ImageHelper;
    ...
    private void getGeneralData() {
        generalService.getGeneralData(new BaseAsyncCallback<GeneralData>() {
            ...
            public void onSuccess(GeneralData generalData) {
                Omlets_mobile.get().setGeneralData(generalData);
