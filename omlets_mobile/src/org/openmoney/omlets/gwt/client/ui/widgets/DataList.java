...
import org.openmoney.omlets.gwt.client.Messages;
import org.openmoney.omlets.gwt.client.ui.Icon;
import org.openmoney.omlets.gwt.client.utils.BaseAsyncCallback;
import org.openmoney.omlets.gwt.client.utils.ComponentEventHelper;
import org.openmoney.omlets.gwt.client.utils.IterableJsArray;
import org.openmoney.omlets.gwt.client.utils.ResultPage;
...
public abstract class DataList<T extends JavaScriptObject> extends Composite {
    ...
    protected void adjustPager(AbstractPager pager) {
        ...
        int height =  Omlets_mobile.get().getMainLayout().getMainHeight();
        if(height != 0) {
