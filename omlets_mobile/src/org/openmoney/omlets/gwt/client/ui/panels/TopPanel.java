 ...
 */
package org.openmoney.omlets.gwt.client.ui.panels;
...
import org.openmoney.omlets.gwt.client.ui.widgets.Spinner;
import org.openmoney.omlets.gwt.client.ui.widgets.ToolbarButton;
import org.openmoney.omlets.gwt.client.ui.widgets.ToolbarButton.ButtonType;
    ...
    private ClickHandler getSpinnerClickHandler() {
        return new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                Omlets_mobile.get().getMainLayout().show(null);
            }
        };        
    }
