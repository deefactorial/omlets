...
import org.openmoney.omlets.gwt.client.accounts.AccountDetailsPage;
import org.openmoney.omlets.gwt.client.accounts.AccountsPage;
import org.openmoney.omlets.gwt.client.configuration.ConfigurationPage;
import org.openmoney.omlets.gwt.client.contacts.ContactDetailsPage;
import org.openmoney.omlets.gwt.client.contacts.ContactSelectPage;
import org.openmoney.omlets.gwt.client.contacts.ContactsPage;
import org.openmoney.omlets.gwt.client.help.HelpPage;
import org.openmoney.omlets.gwt.client.loadgeneraldata.LoadGeneralDataPage;
import org.openmoney.omlets.gwt.client.login.LoginPage;
import org.openmoney.omlets.gwt.client.model.AppState;
import org.openmoney.omlets.gwt.client.model.Parameters;
import org.openmoney.omlets.gwt.client.payments.MakePaymentPage;
import org.openmoney.omlets.gwt.client.payments.PaymentDetailsPage;
import org.openmoney.omlets.gwt.client.payments.PaymentPreviewPage;
import org.openmoney.omlets.gwt.client.payments.PaymentsPage;
import org.openmoney.omlets.gwt.client.ui.Page;
import org.openmoney.omlets.gwt.client.ui.PageAnchor;
import org.openmoney.omlets.gwt.client.ui.widgets.LogoutDialog;
import org.openmoney.omlets.gwt.client.users.UserDetailsPage;
import org.openmoney.omlets.gwt.client.users.UserSearchPage;
import org.openmoney.omlets.gwt.client.users.UserSelectPage;
import org.openmoney.omlets.gwt.client.users.UsersPage;
...
public class Navigation {
    ...
    private PageAnchor getInitialPageAnchor() {
        return getInitialPageAnchor(Omlets_mobile.get().getAppState());
    }
    ...
    private void handle(String token) {               
        ...
        if(StringHelper.isEmpty(token) || exitOnHistoryChange) {
            ...
            Omlets_mobile.get().getPhoneGap().exitApp();
            return;
        }
        ...
        Page currentPage = Omlets_mobile.get().getMainLayout().getCurrentPage();
        ...
        if(isPageAllowed(page)) {
            ...
            // Go to allowed page
            AppState status = Omlets_mobile.get().getAppState();   
    ...
    private boolean isPageAllowed(Page page) {
        AppState appStatus = Omlets_mobile.get().getAppState();                  
    ...
    private void go(Page page) {
        ...
        Omlets_mobile.get().getMainLayout().show(page);
    }
