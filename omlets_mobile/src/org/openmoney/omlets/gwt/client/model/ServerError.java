...
public class ServerError extends JavaScriptObject {
    ...
    public final native ErrorType getError() /*-{
        try {
             return @org.openmoney.omlets.gwt.client.model.ErrorType::valueOf(Ljava/lang/String;)(this.errorCode);
        } catch(e) {
            return @org.openmoney.omlets.gwt.client.model.ErrorType::UNKNOWN_ERROR;
        }
    }-*/;
