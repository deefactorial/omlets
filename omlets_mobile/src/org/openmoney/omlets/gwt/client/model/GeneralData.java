...
public class GeneralData extends JavaScriptObject {
    ...
    public final native CredentialType getCredentialType() /*-{
        return @org.openmoney.omlets.gwt.client.model.CredentialType::valueOf(Ljava/lang/String;)(this.credentialType);
    }-*/;
    ...
    public final native PrincipalType getPrincipalType() /*-{
        return @org.openmoney.omlets.gwt.client.model.PrincipalType::valueOf(Ljava/lang/String;)(this.principalType);
    }-*/;
