...
public class CustomField extends Entity {
    ...
    public final native CustomFieldType getType() /*-{
        return @org.openmoney.omlets.gwt.client.model.CustomFieldType::valueOf(Ljava/lang/String;)(this.type);
    }-*/;

    public final native CustomFieldControl getControl() /*-{
        return @org.openmoney.omlets.gwt.client.model.CustomFieldControl::valueOf(Ljava/lang/String;)(this.control);
    }-*/;
