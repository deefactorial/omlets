...
import org.openmoney.omlets.gwt.client.utils.AmountHelper;
import org.openmoney.omlets.gwt.client.utils.JsonHelper;
...
public class PaymentPreview extends JavaScriptObject {
    ...
    public final JsArray<Fee> getFees() {
        if(Omlets_mobile.get().getGeneralData().getCyclosVersion().equals("3.7")) {
            return ensureFees();
        }
