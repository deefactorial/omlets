 ...
 */
package org.openmoney.omlets.gwt.client.configuration;

import java.util.ArrayList;
import java.util.List;

import org.openmoney.omlets.gwt.client.Configuration;
import org.openmoney.omlets.gwt.client.Omlets_mobile;
...
import org.openmoney.omlets.gwt.client.model.ConfigurationStatus;
import org.openmoney.omlets.gwt.client.services.ConfigurationService;
...
import org.openmoney.omlets.gwt.client.ui.widgets.LabelField;
import org.openmoney.omlets.gwt.client.ui.widgets.LoadingPopup;
import org.openmoney.omlets.gwt.client.ui.widgets.SimpleSelectionField;
import org.openmoney.omlets.gwt.client.ui.widgets.TextField;
import org.openmoney.omlets.gwt.client.utils.BaseAsyncCallback;
import org.openmoney.omlets.gwt.client.utils.PageAction;
import org.openmoney.omlets.gwt.client.utils.PageActionAsync;
import org.openmoney.omlets.gwt.client.utils.ScreenHelper;
...
public class ConfigurationPage extends Page {
    ...
    public List<PageAction> getPageActions() {
        ...
        if(Omlets_mobile.get().getAppState() == AppState.NO_LOGGED_USER) {
                            ...
                            case RELOAD_APP:
                                ...
                                Notification.get().alert(supportsReload ? messages.theLanguageHasChanged() : messages.theLanguageHasChangedNoReload(), messages.notice(), messages.ok(), new AlertCallback() {                                    
                                    ...
                                    public void onOkButtonClicked() {
                                        ...
                                        if(supportsReload) {
                                            Omlets_mobile.get().reloadApplication();
                                        } else {
