    ...
    private static native JavaScriptObject deepCopyImpl(JavaScriptObject obj) /*-{
        ...
        if (obj instanceof Date) {
            ...
            for (var i = 0, len = obj.length; i < len; i++) {
                ...
                else copy[i] = @org.openmoney.omlets.mobile.client.utils.JsonHelper::deepCopyImpl(Lcom/google/gwt/core/client/JavaScriptObject;)(obj[i]);
            }
        } else {
            // Handle Object
            copy = {};
            for (var attr in obj) {
                if (obj.hasOwnProperty(attr)) {
                    ...
                    else copy[attr] = @org.openmoney.omlets.mobile.client.utils.JsonHelper::deepCopyImpl(Lcom/google/gwt/core/client/JavaScriptObject;)(obj[attr]);
                }
            }
        }        
        return copy;
