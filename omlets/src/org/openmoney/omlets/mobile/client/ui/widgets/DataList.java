...
import org.openmoney.omlets.mobile.client.utils.IterableJsArray;
...
//            scrollPanel.add(down);
    ...
    protected void adjustPager(AbstractPager pager) {
        ...
        int height =  OmletsMobile.get().getMainLayout().getMainHeight();
        if(height != 0) {
     ...
     * the function is found in library.js
     */
    public static native void resizeRow() /*-{
		$wnd.resizeRow();
		$wnd.console.log("resizeRow event called();");
	}-*/;
    /**
