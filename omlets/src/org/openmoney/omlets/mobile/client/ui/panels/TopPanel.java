...
import org.openmoney.omlets.mobile.client.ui.widgets.Spinner;
import org.openmoney.omlets.mobile.client.ui.widgets.ToolbarButton;
import org.openmoney.omlets.mobile.client.ui.widgets.ToolbarButton.ButtonType;
    ...
    private ClickHandler getSpinnerClickHandler() {
        return new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                OmletsMobile.get().getMainLayout().show(null);
            }
        };        
    }
